...
//====================================================
// RAM - Circular Buffer with Dual-Port RAM
...
module ram (
    ...
    assign wr_full = (wr_ptr_bin[PTR_WIDTH-1] != rd_ptr_bin_sync[PTR_WIDTH-1]) && // Different wrap count
                 (wr_ptr_bin[PTR_WIDTH-2:0] == rd_ptr_bin_sync[PTR_WIDTH-2:0]);   // Same position within buffer
